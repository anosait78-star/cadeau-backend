...
**As of:** end of EPIC-16 — 2026-08-02 · 13 delivered modules · 63 tables · 127 endpoints.
EPIC-16 itself added no new backend module (frontend-only shared-UI-infra
migration, see [epic-16-quality-gate.md](epic-16-quality-gate.md)); the
table/endpoint deltas below since EPIC-15 come from separately-reviewed
feature work landed in the same session (Bosta carrier connections,
company-onboarding/WhatsApp fields, account-deletion tracking).
...
| `tenancy`       | 4    | `/v1/companies` …                 | `companies`, `company_members`, `invitations`, `whatsapp_templates`                                                                                                                                                                                                                                                                                  | —                                                                                                 |
...
| `shipping`      | 12   | `/v1/shipping`                    | `shipments`, `shipping_webhook_events`, `carrier_connections`                                                                                                                                                                                                                                                                                        | `shipment.created` / `.status_changed` / `.delivered`                                             |
...
| `integrations`  | —    | `/v1/integrations/storefront`     | `storefront_connections`, `storefront_webhook_events`                                                                                                                                                                                                                                                                                                | none new — an additional publisher through `orders`/`products`/`inventory` (D9)                   |
| `health`        | 1    | `/health`                         | —                                                                                                                                                                                                                                                                                                                                                    | —                                                                                                 |
